    ...
    return (
      <Switch>
        <Route
          ...
          render={() => (
            <DashboardHome collapsed={collapsed} onCollapse={this.onCollapse} user={user} />
          )}
        />
        <Route
          path="/admin/boletas"
          render={() => (
            <DashboardTickets collapsed={collapsed} onCollapse={this.onCollapse} user={user} />
          )}
        />
        <Route
          path="/admin/registros"
          render={() => (
            <DashboardRegistry collapsed={collapsed} onCollapse={this.onCollapse} user={user} />
          )}
        />
        <Route
          path="/admin/historial"
          render={() => (
            <DashboardHistory collapsed={collapsed} onCollapse={this.onCollapse} user={user} />
          )}
        />
        <Route
          path="/admin/mensajes"
          render={() => (
            <DashboardMessages collapsed={collapsed} onCollapse={this.onCollapse} user={user} />
          )}
        />
